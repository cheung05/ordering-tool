...
// 匯入五十嵐菜單
// ─────────────────────────────────────────────
async function import50LanMenu(btn) {
  ...
  const data = [
    ...
    ["五十嵐", "鮮柚綠(M)", 60, "找好茶"],
    ["五十嵐", "鮮柚綠(L)", 75, "找好茶"],
    ["五十嵐", "四季春+珍波椰(M)", 40, "找口感"],
    ["五十嵐", "四季春+珍波椰(L)", 50, "找口感"],
    ["五十嵐", "波霸紅茶(M)", 40, "找口感"],
    ["五十嵐", "波霸紅茶(L)", 50, "找口感"],
    ["五十嵐", "波霸綠茶(M)", 40, "找口感"],
    ["五十嵐", "波霸綠茶(L)", 50, "找口感"],
    ...
    ["五十嵐", "綠茶拿鐵(M)", 60, "紅茶拿鐵"],
    ["五十嵐", "綠茶拿鐵(L)", 75, "紅茶拿鐵"],
    ["五十嵐", "黃金烏龍拿鐵(M)", 60, "紅茶拿鐵"],
    ["五十嵐", "黃金烏龍拿鐵(L)", 75, "紅茶拿鐵"],
    ["五十嵐", "阿華田拿鐵(M)", 65, "紅茶拿鐵"],
    ["五十嵐", "阿華田拿鐵(L)", 80, "紅茶拿鐵"],
    ["五十嵐", "冰淇淋紅茶(M)", 50, "找冰淇淋"],
    ["五十嵐", "冰淇淋紅茶(L)", 60, "找冰淇淋"],
  ...
  try {
    ...
    showToast('「五十嵐」菜單已成功大量匯入 Google 試算表！', 'success');
  } catch (err) {
    console.error('匯入五十嵐菜單失敗:', err);
    showToast('匯入失敗，可能是沒有編輯權限，請確認', 'error');
  } finally {
    btn.disabled = false;
